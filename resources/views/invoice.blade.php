...
<div id="wrapper">
    ...
    <div class="container" style="width: 200mm;padding: 0px;">
            ...
            <table class="table">
                ...
                <tr>
                    <td style="border-style: none;padding-right: 40px;padding-bottom: 20px;">
                        <hr style="width: 25px;height: 3px;color: rgb(0,0,0);background: rgb(0,0,0);border-color: rgb(0,0,0);margin-bottom: 4px;">
        ...
        <div class="save_print_div noprint">
            ...
            <button class="btn btn-primary" type="button"><i class="far fa-save" style="width: 20px;height: 20px;font-size: 20px;"></i></button></div>
    </div>
</div>
